...
- [ ] Création de l'object NodeList dans Mongo
...
- [ ] getNodeList dans le frontend
- [ ] affichage dans l'onglet Exploration
- [ ] ajout d'un Spinner au clic de l'onglet Exploration "Construction arborescence..."
