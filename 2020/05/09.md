...
- [ ] Etudier l'exploration d'un serveur OPCUA
  ...
  - [ ] Ajouter un champ de recherche dans le JSON Exploration
    ...
    - [ ] Renvoyer le tableau de browseName vers le composant Exploration pour afficher le nombre de node trouvés sous chaque composant ouvert
