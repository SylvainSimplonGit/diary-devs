...
- 09h00 - 10h00 : Lightning talk
- 10h00 - 11h00 : Revue de code
- 11h00 - 12h00 : daily meeting
- 12h00 - 12h45 : Hermine
- 12h45 - 13h45 : Repas
- 13h45 - 14h00 : Diary
- 14h00 - 14h25 : GetAllEvents Ajout de filtre
- 14h25 - 14h30 : Pause
- 14h30 - 14h55 : GetAllEvents Ajout de tri
- 14h55 - 15h00 : Pause
- 15h00 - 15h25 : GetAllEvents Ajout de limite
- 15h25 - 15h30 : Pause
- 15h30 - 15h55 : Pause café
- 15h55 - 16h00 : Pause
- 16h00 - 16h25 : Tests GetAllEvents
- 16h25 - 16h30 : Pause
- 16h30 - 16h55 : Remplacer siteEvent par siteUai dans l'object Event
- 16h55 - 17h00 : Pause
- 17h00 - 17h25 : Modifier api.getEvents pour utiliser la nouvelle API avec filtre, etc...
- 17h25 - 17h30 : Pause
- 17h30 - 17h55 : Modifier api.getEvents pour utiliser la nouvelle API avec filtre, etc...
- 17h55 - 18h00 : Pause
...
- [ ] Sortir la méthode mongoose de création d'Event
- [ ] Appeler la méthode de création Mongoose d'Event dans la méthode createEvent API
- [ ] Appeler la méthode de création Mongoose d'Event dans la méthode createEvent MQTT
- [x] Supprimer la méthode deleteEvent du router (plus d'appel par API)

### Frontend

- [ ] Créer un composant Event qui sera utiliser 3 fois dans le Dashboard
- [ ] Modifier api.getEvents pour faire appelle à la nouvelle API avec filtre, tri et limite
